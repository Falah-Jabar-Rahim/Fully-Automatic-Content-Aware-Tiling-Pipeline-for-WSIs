...
def inti_model_artifact():
    ...
    parser.add_argument('--cpu_workers', default=32, type=int, help='number of cpu workers')
    parser.add_argument('--save_seg', default=0, type=int, help='to save tile segmentation results')
    parser.add_argument('--back_thr', default=50, type=int, help='% of background for each tile (eg., remove tiles with 50% background)')
    parser.add_argument('--blur_fold_thr', default=5, type=int, help='% of blur and fold (eg., remove tiles with 10% fold or blur)')
    parser.add_argument('--overlap', default=25, type=int, help='overlapping between neighbouring tiles')
    parser.add_argument('--max_marker_thr', default=0.7, type=float, help='max thr for pen-marking detection')
    parser.add_argument('--min_marker_thr', default=0.2, type=float, help='min thr for pen-marking detection')
    parser.add_argument('--clean_penmarker', default=0, type=int, help='to remove pen-marking or 0 do not remove pen-marking')
